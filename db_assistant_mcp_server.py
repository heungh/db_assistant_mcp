...
📋 **테이블 목록** ({len(tables_info)}개):"""
  ...
  🔹 **{table_name}** ({engine})
    ...
    async def text_to_sql(self, database_secret: str, natural_language_query: str) -> str:
        ...
        try:
            ...
            # Claude에게 SQL 생성 요청
            sql_query = await self.generate_sql_with_claude(natural_language_query, schema_info)
    ...
    async def generate_sql_with_claude(self, natural_query: str, schema_info: dict) -> str:
